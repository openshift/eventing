...
function delete_serving_openshift() {
  ...
  oc delete --ignore-not-found=true -f https://raw.githubusercontent.com/openshift/knative-serving/release-${SERVING_VERSION}/openshift/olm/knative-serving.catalogsource.yaml
}
